...
import pygame, os, time, math, importlib.util, socket
...
# Walker's horroshow for bad networking
...
def main():
    ...
    # Connect to server
    # Set all the server to use ipv4 and TCP
    serverSocket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    # Get the ip from the user and set the port
    host = str(input("What is the server IP?: "))
    port = 8888
    ...
    try:
        ...
        print("Could not connect, check network connection and IP address") 
